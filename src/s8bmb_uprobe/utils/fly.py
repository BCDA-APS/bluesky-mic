...
setup_detectors_and_fileio(stepsize_x, num_pulses, motor_resolution, dwell_time, 
                          sis3820_on=True, xp3_on=True, tmm1_on=False, preamp1_on=True, preamp2_on=False)
...
validate_device_connections(sis3820_on, xp3_on, tmm1_on, preamp1_on, preamp2_on, return_devices=False)
