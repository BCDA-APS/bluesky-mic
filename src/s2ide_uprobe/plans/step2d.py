...
def step2d(
    ...
    yield from generalized_scan_1d(scan1, samx, savedata, scan_overhead=scan_overhead,
                                    scanmode=scanmode, x_center=0, width=width, 
    ...
    yield from generalized_scan_1d(scan2, samy, savedata, scan_overhead=scan_overhead,
                                   scanmode=scanmode, x_center=0, width=height, 
