...
def create_xml_structure():
    ...
    root.set("xsi:schemaLocation", "http://epics.aps.anl.gov/areaDetector/attributes ../attributes.xsd")
...
def main():
    ...
    parser.add_argument('input', nargs='?', default='savepv.json', 
                       help='Input JSON file (default: savepv.json)')
    parser.add_argument('-o', '--output', default='attributes_from_json.xml',
