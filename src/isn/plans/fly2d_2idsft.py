...
def fly2d(
    ...
    if all([scan1.connected, scan2.connected]):
        ...
        msg = f"Having issue connecting to scan records: {scan1.prefix}, {scan2.prefix}"
        print(msg)
    ...
    #     else:
    # #         logger.error("Not able to perform the desired scan due to hardware "
    #     #                     "connection")
...
#             scan1, scan2, scan_type, loop1, loop2, x, y, dwell, npts_line,
#             trigger1=trigger1, trigger2=trigger2
#         )
#         yield from setup_savedata(savedata, pi_directory, sample_name,
#                                reset_counter=False)
#     else:
...
#             xp3, npts_tot, sample_name, savepath, dwell, trigger_mode,
#             scanNumber, reset_counter=False
#         )
...
#             tmm, npts_tot, sample_name, savepath, dwell, trigger_mode,
#             scanNumber, reset_counter=False
#         )
...
#             f"positions_{formated_number}.h5",
#             f"{save_path}positions"
#         )
#     else:
#         print("file number not tracked. Not sure how else to set file name if not "
#               "based on another detector's filenumber")
...
#         yield from bps.mv(
#             m1.velocity, 3, m1.acceleration, 0.1,
#             m2.velocity, 3, m2.acceleration, 0.1
#         )
...
#     st = Status()
#     #TODO: needs monitoring function incase detectors stall or one of teh iocs
#     # crashes.
...
#     # TODO need some way to check if devices are ready before proceeding. timeout
#     # and exit with a warning if something is missing.
#     # if motors.inpos and pm1.isready and tmm.isready and xp3.isready and
#     # sgz.isready and postrm.isready:
